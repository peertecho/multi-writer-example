...
function getEncoding(name) {
  switch (name) {
    ...
    case '@multiWriter/users':
      return encoding2
    case '@multiWriter/events':
      return encoding3
    case '@multiWriter/writers/hyperdb#0':
      return encoding4
    case '@multiWriter/invites/hyperdb#1':
      return encoding5
    case '@multiWriter/users/hyperdb#2':
      return encoding6
    default:
